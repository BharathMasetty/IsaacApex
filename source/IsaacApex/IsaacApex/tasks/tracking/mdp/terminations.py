...
#
"""Tracking termination terms — fail an episode when the robot drifts too far
from the reference (height of the anchor, anchor tilt, or end-effector height).
...
from IsaacApex.tasks.tracking.mdp.rewards import _get_body_indexes
